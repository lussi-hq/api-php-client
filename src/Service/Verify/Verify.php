...
class Verify extends AbstractAuthenticatedService
{
     ...
     */
    public function createVerification(string $to, string $region, string $channel): ResponseInterface
    {
     ...
     */
    public function checkVerification(string $to, string $code, string $region, string $channel): ResponseInterface
    {
